...
<body>
    <main id="main">
        ...
        <?php
            ...
            $sql2 = "SELECT * FROM serie WHERE ID_usuario = $id AND Tipo = 'A'";
            //Executa o SQL
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center d-flex justify-content-evenly">
                                            <a id="editar" href="" data-bs-toggle="modal" data-bs-target="#modal_editar"
                                                ...
                                                <img src='images/editar.png' alt='Editar Usuário'>
                                            </a>
        ...
        <?php 
        $sql3 = "SELECT * FROM serie WHERE ID_usuario = $id AND Tipo = 'B'";
            //Executa o SQL
        ...
        <?php 
        $sql4 = "SELECT * FROM serie WHERE ID_usuario = $id AND Tipo = 'C'";
            //Executa o SQL
        ...
        <?php 
        $sql5 = "SELECT * FROM serie WHERE ID_usuario = $id AND Tipo = 'D'";
            //Executa o SQL
