...
$email = $_SESSION['email'];
  ...
  //Puxa as informações
  $sql = "SELECT * FROM agendamento INNER JOIN usuario ON agendamento.ID_usuario = usuario.ID_usuario WHERE status='Aguardando' ORDER BY Data_agendamento";
                          ...
                          <?php
						    ...
						    <tr>
                                ...
                                <td class="text-center d-flex justify-content-around">
                                        <a  href="alunoAvaliacao.php?id=<?= $row['ID_usuario']?>">
                                            <img src="images/regua.png">
                                        </a>
                                        <a href="alunoSerie.php?id=<?= $row['ID_usuario']?>">
                                            <img src="images/halter.png">
                                        </a>
