...
$query_event = "INSERT INTO agendamento (ID_usuario, Titulo, cor, Data_agendamento, fim, status) VALUES (:ID_usuario, :title, :cor, :comeco, :fim, :status)";

$insert_event = $conn->prepare($query_event);
$insert_event->bindParam(':ID_usuario', $id);
