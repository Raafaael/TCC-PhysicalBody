...
$email = $_SESSION['email'];
  ...
  //Puxa as informações
  $sql = "SELECT * FROM usuario INNER JOIN plano ON usuario.ID_plano = plano.ID_plano LEFT JOIN medida ON usuario.ID_usuario = medida.ID_usuario WHERE Email = '$email' ORDER BY medida.ID_medida DESC";
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="input-group mb-3">
                  <input type="hidden" name="id" class="form-control" value="<?php echo $row["ID_usuario"]; ?>"
        ...
        <div class="modal fade" id="modal_cancelar" tabindex="-1" role="dialog" aria-labelledby="Cancelar"
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="input-group mb-3">
                  <input type="hidden" name="id" class="form-control" value="<?= $row["ID_usuario"]; ?>"
                    aria-label="ID" aria-describedby="basic-addon2">
                </div>
