    ...
    <section>
        <div>
            <form action="processoatualizar.php" method="post">
                ...
                <input type="text" name="nome" value="<?= $row["Nome"]; ?>" placeholder="Seu nome"
                    autocomplete="off" required>
                <input type="email" name="email" value="<?= $row["Email_aluno"]; ?>" placeholder="Seu e-mail"
                    autocomplete="off" required>
                ...
                <input type="date" name="data" minlenght="10" maxlenght="10" onfocus="(this.type='date')"
                    onblur="if(!this.value) this.type='text'" value="<?= $row["Data_de_nascimento"]; ?>"
                    placeholder="Data de Nascimento" autocomplete="off" required>
                <input type="text" name="telefone" onkeypress="$(this).mask('(00) 00000-0000')"
                    value="<?= $row["Telefone"]; ?>" placeholder="Seu Telefone" autocomplete="off" required>
