...
require 'conexao.php';
    ...
    $sql5 = "SELECT * FROM usuario WHERE Chave='$chave'";
...
if(!empty($_GET['session_id'])){
    ...
    $sql = "SELECT * FROM pagamento WHERE ID_usuario = '$id'";
        ...
        if(empty($api_error) && $checkout_session){
            ...
            if(empty($api_error) && $intent){ 
                ...
                if(($intent->status == 'succeeded') && ($pageview == '1')){
					...
					$sql = "INSERT INTO pagamento(ID_usuario, Valor, Data_pagamento) VALUES('$id', '".$rowproduct['Preco']."', '$start')"; 
                    $sql2 = "UPDATE usuario SET ID_plano='$pageview', Inicio='$start', Expiracao='$end', Condicao='Ativo' WHERE ID_usuario='$id'";    
